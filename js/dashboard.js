// ==========================================
// Dashboard Page Functionality with Mock Support
// ==========================================
...
function loadTopics() {
  ...
  if (MOCK_MODE) {
    // Use mock data
    setTimeout(() => {
      renderTopics(MockData.topics, container);
    }, 800);
  } else {
    // Use real API
...
function updateTopicDifficulty(topicId, difficulty) {
  ...
  if (MOCK_MODE) {
    ...
    console.log("Difficulty updated in mock data:", topicId, difficulty);
  } else {
    // Use real API
...
function loadMaterials() {
  ...
  if (MOCK_MODE) {
    // Use mock data
    setTimeout(() => {
      renderMaterials(MockData.materials, container);
    }, 800);
  } else {
    // Use real API
...
function loadDeadlines() {
  ...
  if (MOCK_MODE) {
    // Use mock data
    setTimeout(() => {
      renderDeadlines(MockData.deadlines, container);
    }, 800);
  } else {
    // Use real API
...
function loadSchedule() {
  ...
  if (MOCK_MODE) {
    // Use mock data
    setTimeout(() => {
      renderSchedule(MockData.schedule, container);
    }, 800);
  } else {
    // Use real API
